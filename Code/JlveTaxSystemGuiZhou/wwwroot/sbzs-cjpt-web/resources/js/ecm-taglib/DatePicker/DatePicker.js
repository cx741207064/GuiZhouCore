...
DatePicker Style
*/
DatePicker.prototype.style = function(){
	var strStyle = "<style type='text/css'>";
	strStyle += ".calendar {font-size:12px; margin:0;padding:0px;border:1px solid #53bdbd;background-color:#DBE7F2;}";
	...
	strStyle += ".calendar .day li {height:25px;}";
	strStyle += ".calendar .day li,.calendar .date li{float:left;width:14.13%;height:25px;line-height:21px;text-align:center;}";
	strStyle += ".calendar .day li{font-weight:bold;} .calendar .date li{background-color:#EDF3F9;}";
	strStyle += ".calendar .month li{float:left;width:24.8%;height:25px;line-height:21px;text-align:center;background-color:#EDF3F9;}";
	strStyle += ".calendar li a{ text-decoration:none; font-family:Tahoma; font-size:12px; color:#333}";
	...
	strStyle += ".lastMonthDate, .nextMonthDate {color:#bbb;font-size:12px}";
	...
	strStyle += ".calendarTitle{background:#EDF3F9;text-align:center;height:25px;line-height:25px;clear:both;width:100%;}";
	strStyle += ".calendarTitle .mark{text-decoration:none;color:#000;font-family:Tahoma;font-size:18px;font-weight:normal;}";
	strStyle += ".today{ background-color:#e5f3fb;border:1px solid #53bdbd;display:inline-block; width:23px;height:23px;align:center;}";
	strStyle += ".today a { color:#f30; }";
	strStyle += ".calendarBottom {text-align:center;height:25px;line-height:25px;clear:both;width:100%;border-top:1px solid #ddd;}";
	strStyle += ".calendarBottom li{float:left;height:25px;line-height:25px;font-weight:bold;text-align:center;}";
	strStyle += "</style>";
	return strStyle;
}
...
DatePicker.prototype.style = function(){
	...
	strStyle += ".calendar ul {list-style-type:none; margin:0; padding:0;vertical-align:middle;}";
	strStyle += ".calendar li {float:left;}.calendar b{font-weight:bold;}";
	strStyle += ".calendar .day { background-color:#EDF5FF; height:25px;}";
	strStyle += ".calendar .day li,.calendar .date li{ float:left; width:14.13%; height:25px; line-height:21px; text-align:center}";
	strStyle += ".calendar .month li{ float:left; width:24.8%; height:25px; line-height:21px; text-align:center}";
	strStyle += ".calendar li a{ text-decoration:none; font-family:Tahoma; font-size:12px; color:#333}";
	...
	strStyle += ".selectThisYear, .selectThisMonth{text-decoration:none; margin:0px; color:#000; font-weight:bold}";
	strStyle += ".calendar .LastMonth, .calendar .NextMonth{text-decoration:none; color:#000; font-size:18px; font-weight:bold; line-height:16px;}";
	strStyle += ".calendarTitle {text-align:center;height:25px;line-height:25px;clear:both;width:100%;}";
	...
	strStyle += ".today{ background-color:#ffffaa;border:1px solid #f60;display:inline-block; width:23px;height:23px;align:center;}";
	strStyle += ".today a { color:#f30; }";
	strStyle += ".calendarBottom {text-align:center;height:25px;line-height:25px;clear:both;width:100%;border-top:1px solid #ddd;}";
	strStyle += ".calendarBottom li{float:left;height:25px;line-height:25px;font-weight:bold;text-align:center;}";
	strStyle += "</style>";
...
function DatePicker(option) {
  if(!option || !option.inputObj){
	  return false;
  }
  this.dateControl = option.inputObj;
  //default parameter value
  this.beginDate = "1900-01-01".toDate();
  this.endDate = "2099-12-30".toDate();
  this.lang = 0;
  this.type = "d";
  ...
  if (null != option.dateFormatStyle){
	  this.dateFormatStyle = option.dateFormatStyle;
  }
  
  if (null != option.beginDate){
	  this.beginDate = option.beginDate.toDate();
  }
  
  if(null != option.endDate){
	  this.endDate = option.endDate.toDate();
  }
  ...
  if (null != option.isShowClear) {
	  this.isShowClear = option.isShowClear;
  }
  
  if (null != option.callBack) {
  ...
  if ("value" in option.inputObj) {
	  if(null != option.inputObj.value && "" != option.inputObj.value){
	  	currDate = option.inputObj.value.toDate(this.dateFormatStyle);
	  }
  } else if("innerHTML" in option.inputObj){
	  if(null != option.inputObj.innerHTML && "" != option.inputObj.innerHTML){
		currDate = option.inputObj.innerHTML.toDate(this.dateFormatStyle);
	  }
  }
...
DatePicker.prototype.draw = function() {   
  ...
  lis += "<li id='PrevYear' class='mark' style='width:10%;' title='Previous Year'>&laquo;</li>";
  if("d" == this.type){
  	lis += "<li id='PrevMonth' class='mark' style='width:10%;' title='Previous Month'>&lsaquo;</li>";
    lis += "<li style='width:30%;'><span id='selectThisYear' class='selectThisYear'>" + this.date.getFullYear() + DatePicker.language["title"][this.lang][0] + "</span><span id='selectThisYearSpan' class='selectThisYear' style='display:none;'></span></li>";
  	if(0 == this.lang){
  		lis += "<li style='width:30%;'><span id='selectThisMonth' class='selectThisMonth'>" + DatePicker.language["months"][this.lang][this.date.getMonth()] + "</span><span id='selectThisMonthSpan' class='selectThisMonth' style='display:none;'></span></li>";
  	}else{
  		lis += "<li style='width:30%;'><span id='selectThisMonth' class='selectThisMonth'>" + (this.date.getMonth() +1) + DatePicker.language["title"][this.lang][1] + "</span><span id='selectThisMonthSpan' class='selectThisMonth' style='display:none'></span></li>";
  	}
  	lis += "<li id='NextMonth' class='mark' style='width:10%;' title='Next Month'>&rsaquo;</li>";
  	lis += "<li id='NextYear' class='mark' style='width:10%;' title='Next Year'>&raquo;</li></ul></div>";
	lis += "<div class='calendarBody'>";
  	lis += "<ul class='day'>";
  	for(var i=0;i<DatePicker.language.weeks[this.lang].length;i++){
  		lis += "<li title='" + DatePicker.language.weekday[i] + "'>" + DatePicker.language.weeks[this.lang][i] + "</li>";
  	}
	...
	if (this.isShowClear) {
		lis += "<li id='emptyCalendar' style='width:27%;' title='Clear'>" + DatePicker.language.clear[this.lang] +"</li>";
		lis += "<li id='selectCurrent' style='width:45%;' title='Today'>" + DatePicker.language.today[this.lang][0] +"</li>";
	} else {
		lis += "<li id='selectCurrent' style='width:45%;padding-left:27%;' title='Today'>" + DatePicker.language.today[this.lang][0] +"</li>";
	}
  }else{
  	lis += "<li style='width:80%;'><span id='selectThisYear' class='selectThisYear'>" + this.date.getFullYear() + DatePicker.language["title"][this.lang][0] + "</span><span id='selectThisYearSpan' class='selectThisYear' style='display:none;'></span></li>";
  	lis += "<li id='NextYear' class='mark' style='width:10%;' title='Next Year'>&raquo;</li></ul></div>";
  	lis += "<div class='calendarBody'>";
	...
	if (this.isShowClear) {
		lis += "<li id='emptyCalendar' style='width:27%;' title='Clear'>" + DatePicker.language.clear[this.lang] +"</li>";
		lis += "<li id='selectCurrent' style='width:45%;' title='Current Month'>" + DatePicker.language.today[this.lang][1] +"</li>";
	} else {
		lis += "<li id='selectCurrent' style='width:45%;padding-left:27%;' title='Current Month'>" + DatePicker.language.today[this.lang][1] +"</li>";
	}
  }
  if (this.isShowClear) {
	  lis += "<li id='closeCalendar' style='width:27%;' title='Close'>" + DatePicker.language.close[this.lang] +"</li>";
  } else {
	  lis += "<li id='closeCalendar' style='width:27%;' title='Close'>" + DatePicker.language.close[this.lang] +"</li>";
  }
...
/**
* Bind Click Event into DatePicker
*/
DatePicker.prototype.bingEvent = function(){
  var calendar = this;
  ...
  this.getElementById("selectCurrent").onclick = function(){
  	  ...
  	  calendar.hide();
	  if (calendar.callBack != null && typeof calendar.callBack == "function") {
		  calendar.callBack();
	  }
  }
  
  if (calendar.isShowClear) {
	  this.getElementById("emptyCalendar").onclick = function(){
		 if ("value" in calendar.dateControl) {
			  calendar.dateControl.value = "";
		  } else {
			  calendar.dateControl.innerHTML = "";
		  }
		  calendar.hide();
		  if (calendar.callBack != null && typeof calendar.callBack == "function") {
			  calendar.callBack();
...
DatePicker.prototype.selectThisYear = function(){
	var calendar = this;
	var curYear = this.date.getFullYear();
	var beginYear = this.beginDate.getFullYear();
	var endYear = this.endDate.getFullYear();
	var spanObj = this.getElementById("selectThisYearSpan");
	var selectStr = "<select id='selectThisYearSubSelect' style='font-size:12px;height:25px;line-height:25px;'>";
	...
	var selectYearObj = this.getElementById("selectThisYearSubSelect");
...
DatePicker.prototype.selectThisMonth = function(){
	var calendar = this;
	...
	var spanObj = this.getElementById("selectThisMonthSpan");
	var selectStr = "<select id='selectThisMonthSubSelect' style='font-size:12px;height:25px;line-height:25px;'>";
	for(var i = 1; i <= endMonth; i++){
		selectStr += "<option value='" + i + "'>" + DatePicker.language["months"][this.lang][i-1] + "</option>";
	}
	selectStr += "</select>";
	spanObj.innerHTML = selectStr;
	spanObj.style.display = "block";
	var selectMonthObj = this.getElementById("selectThisMonthSubSelect");
...
DatePicker.prototype.valueSelected = function(date){
	if ("value" in this.dateControl) {
		this.dateControl.value = date.format(this.dateFormatStyle);
	} else {
		this.dateControl.innerHTML = date.format(this.dateFormatStyle);
	}
}

/**
* Set Auto Height for DatePicker Panel Div
*/
DatePicker.prototype.setAutoHeight = function(){
...
DatePicker.prototype.getElementById = function(id){
...
DatePicker.prototype.getElementsByTagName = function(tagName){
  if(null == this.document) return null;
...
DatePicker.prototype.getAbsPoint = function (e){   
  var x = e.offsetLeft;   
  var y = e.offsetTop;   
...
DatePicker.prototype.setDisplayStyle = function(tagName, style) {   
...
document.write('<div id="calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;font-size:12px;width:20px;height:1px;" tabindex="0">');
